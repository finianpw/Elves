...
public sealed class GameForm : Form
{
    ...
    private readonly Image? _backgroundArtwork;
    private readonly Image? _elfArtwork;
    ...
    private static Image? LoadArtwork(string fileName)
    {
    ...
    private void DrawHud(Graphics g)
    {
        ...
        g.DrawString("ESC - menu (poziom, jasność, restart, wyjście)", _hudFont, Brushes.White, 450, 79);
