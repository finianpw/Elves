...
## Podmiana grafiki na dokładne obrazy
1. Umieść tło (jak na załączonym obrazie) jako:
   `ElfForestSaga.Game/Assets/visuals/background-main.png`
2. Umieść render/model elfa (jak na referencji) jako:
   `ElfForestSaga.Game/Assets/visuals/elf-3d.png`
3. Uruchom grę — engine automatycznie wczyta te pliki i pokaże je w grze.
