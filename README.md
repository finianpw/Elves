...
- Menu pod `Esc`:
  ...
  - cofanie zmian (muzyka/tło/elf lub wszystko).
- Finałowy boss: 21. poziom to samotny pojedynek ze smokiem (kolce, zianie ogniem, bardziej realistyczna głowa).
...
4. W menu możesz też cofnąć każdą zmianę osobno lub przyciskiem „Cofnij wszystko”.
